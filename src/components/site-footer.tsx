...
export function SiteFooter() {
  ...
  />
  <p className="mt-6 max-w-sm text-sm leading-7 text-cream/70">Odontologia especializada com escuta, clareza e respeito em cada etapa.</p></div>
